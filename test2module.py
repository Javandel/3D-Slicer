...
class test2moduleWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def informationButtonClicked04(self):
    ...
    croppedImageFnm = "../myCroppedVolume1.nrrd" # give the path for saving result image
  ...
  def informationButtonClicked05(self):
    ...
    # Process
    croppedImagePath = "../myCroppedVolume2.nrrd" # give the path for saving result image
    center = (128, 128, 65)
